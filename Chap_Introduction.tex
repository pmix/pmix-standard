...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%% History: Version 2.2
\section{Version 2.2: Mar. 2019}

The v2.2 update includes clarifications and corrections:

\begin{itemize}
    \item Errata: \refapi{pmix_server_dmodex_req_fn_t} cannot return \refconst{PMIX_OPERATION_SUCCEEDED} as the function signature does not support direct return of the requested data blob
\end{itemize}
