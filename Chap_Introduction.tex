...
The \refstruct{pmix_value_t} data structures has an explicit size requirement to support the PMIx \ac{ABI}.
Changes to the \refstruct{pmix_value_t} must not increase the size of the data structure.
