...
Maximum number of processes that can be executed in this context (session, namespace, application, or node).
}

%
\declareNewAttribute{PMIX_NUM_NODES}{"pmix.num.nodes"}{uint32_t}{
Number of nodes in this session, or currently executing processes from the associated namespace or application.
}
