...
\subsubsection{Free a proc structure}
...
\subsubsection{Free a proc array}
...
\subsubsection{Load a proc structure}
...
\subsubsection{Initialize the data array structure}
...
\subsubsection{Destruct the info structure}
...
%%%%%%%%%%%
\subsubsection{Create an info array}
...
%%%%%%%%%%%
\subsubsection{Free an info array}
...
%%%%%%%%%%%
\subsubsection{Load key and value data into a info struct}
...
\subsubsection{Free an envar array}
...
\subsubsection{Load an envar structure}
...
%%%%%%%%%%%
\subsubsection{Free a pdata structure}
...
%%%%%%%%%%%
\subsubsection{Free a pdata array}
...
\subsubsection{Destruct the app structure}
...
\subsubsection{Initialize the query structure}
...
\subsubsection{Destruct the query structure}
...
%%%%%%%%%%%
\subsubsection{Create a query array}
...
%%%%%%%%%%%
\subsubsection{Free a query structure}
...
%%%%%%%%%%%
\subsubsection{Create a regattr array}
...
%%%%%%%%%%%
\subsubsection{Transfer a regattr to another regattr}
...
\subsubsection{Free a byte object array}
...
\subsubsection{Load a byte object structure}
...
\subsubsection{Create a data array structure}
\declaremacro{PMIX_DATA_ARRAY_CREATE}
...
%
\declareAttributeNEW{PMIX_PSET_NAMES}{"pmix.pset.nm"}{char*}{
Comma-delimited list of process sets and process groups to which the given process is a member.
}
...
\declareAttributeNEW{PMIX_NOTIFY_LAUNCH}{"pmix.note.lnch"}{bool}{
...
%
\declareAttributeNEW{PMIX_FORK_EXEC_AGENT}{"pmix.fe.agnt"}{char*}{
...
Return a comma-delimited list of the names of the process sets defined in the
specified range (defaults to session).
}

%
\declareAttributeNEW{PMIX_QUERY_PSET_MEMBERSHIP}{"pmix.qry.pmems"}{pmix_proc_t*}{
Return an array of \refstruct{pmix_proc_t} of the members of the specified
process set.
}
...
%
\declareAttributeNEW{PMIX_GROUP_INVITE_DECLINE}{"pmix.grp.decline"}{bool}{
