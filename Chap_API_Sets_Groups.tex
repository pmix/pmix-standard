...
\ac{PMIx} supports two slightly related, but functionally different concepts known as \emph{process sets} and \emph{process groups}. This chapter describes the two definitions and how they are utilized, along with their corresponding \acp{API}.
