...
%% The pmix_info_t type (See [add reference to 1.3.1 Attributes in PMIx]), is also built on key-values pairs.  
...
%is different than for non-reserved keys.

Host environments are permitted to provide non-reserved keys.  However there are important caveats to 
