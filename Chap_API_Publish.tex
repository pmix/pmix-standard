...
\pasteAttributeItem{PMIX_DATA_TO_PUBLISH}
\reqattrend
...
%
\declareAttributeNEW{PMIX_DATA_TO_PUBLISH}{"pmix.publishdata"}{pmix_data_array_t}{
Array of \refstruct{pmix_info_t} containing data to be published.
}
