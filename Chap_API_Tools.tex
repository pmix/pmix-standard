...
These constants refer to events that may occur during or following the spawn of the \ac{IL}, typically relating to rendezvous of a tool and launcher during spawn of the \ac{IL}. The events serve as a form of event-driven "handshake" between the two processes, thereby allowing the tool to provide directives to the \ac{IL} prior to the \ac{IL} launching any processes.
...
Debugger release event status - deprecated in favor of
...
Namespace of the job to be debugged - provided to the debugger upon launch (deprecated in favor of \refattr{PMIX_DEBUG_TARGET})
}
