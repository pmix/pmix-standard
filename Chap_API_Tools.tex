...
%
\declareAttribute{PMIX_IOF_LOCAL_OUTPUT}{"pmix.iof.local"}{bool}{
Write output streams to local stdout/err
}
%
\declareAttribute{PMIX_IOF_MERGE_STDERR_STDOUT}{"pmix.iof.mrg"}{bool}{
...
%
\declareAttribute{PMIX_IOF_OUTPUT_RAW}{"pmix.iof.raw"}{bool}{
...
%
\declareAttribute{PMIX_IOF_RANK_OUTPUT}{"pmix.iof.rank"}{bool}{
...
%
\declareAttribute{PMIX_IOF_OUTPUT_TO_FILE}{"pmix.iof.file"}{char*}{
...
%
\declareAttribute{PMIX_IOF_OUTPUT_TO_DIRECTORY}{"pmix.iof.dir"}{char*}{
...
%
\declareAttribute{PMIX_IOF_FILE_PATTERN}{"pmix.iof.fpt"}{bool}{
...
%
\declareAttribute{PMIX_IOF_FILE_ONLY}{"pmix.iof.fonly"}{bool}{
...
\begin{constantdesc}
%
\declareconstitemvalue{PMIX_EVENT_JOB_START}{-191}
...
%
\declareconstitemvalue{PMIX_LAUNCH_COMPLETE}{-174}
...
%
\declareconstitemvalue{PMIX_EVENT_JOB_END}{-145}
...
%
\declareconstitemvalue{PMIX_EVENT_SESSION_START}{-192}
...
%
\declareconstitemvalue{PMIX_EVENT_SESSION_END}{-193}
...
%
\declareconstitemvalue{PMIX_ERR_PROC_TERM_WO_SYNC}{-200}
...
\begin{constantdesc}
%
\declareconstitemvalue{PMIX_ERR_JOB_CANCELED}{-180}
The job was canceled by the host environment.
%
\declareconstitemvalue{PMIX_ERR_JOB_ABORTED}{-182}
One or more processes in the job called abort, causing the job to be terminated.
%
\declareconstitemvalue{PMIX_ERR_JOB_KILLED_BY_CMD}{-183}
The job was killed by user command.
%
\declareconstitemvalue{PMIX_ERR_JOB_ABORTED_BY_SIG}{-184}
The job was aborted due to receipt of an error signal (e.g., SIGKILL).
%
\declareconstitemvalue{PMIX_ERR_JOB_TERM_WO_SYNC}{-185}
...
%
\declareconstitemvalue{PMIX_ERR_JOB_SENSOR_BOUND_EXCEEDED}{-186}
The job was terminated due to one or more processes exceeding a specified sensor limit.
%
\declareconstitemvalue{PMIX_ERR_JOB_NON_ZERO_TERM}{-187}
The job was terminated due to one or more processes exiting with a non-zero status.
%
\declareconstitemvalue{PMIX_ERR_JOB_ABORTED_BY_SYS_EVENT}{-189}
...
%
\declareconstitemvalue{PMIX_DEBUGGER_RELEASE}{-3}
...
%
\declareAttribute{PMIX_DEBUG_STOP_IN_APP}{"pmix.dbg.notify"}{varies}{
...
%
\declareAttribute{PMIX_DEBUG_TARGET}{"pmix.dbg.tgt"}{pmix_proc_t*}{
...
%
\declareAttribute{PMIX_DEBUG_DAEMONS_PER_PROC}{"pmix.dbg.dpproc"}{uint16_t}{
...
%
\declareAttribute{PMIX_DEBUG_DAEMONS_PER_NODE}{"pmix.dbg.dpnd"}{uint16_t}{
...
\returnsimple
In the event the function returns an error, the \refarg{regcbfunc} will \textit{not} be called.
