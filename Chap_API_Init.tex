...
Some \ac{PMIx} implementation (for example, the current \ac{PRI}) may not support connecting a server that is not under the same namespace manager (e.g., host \ac{RM}).
\adviceuserend
