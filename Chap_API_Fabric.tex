...
\begin{constantdesc}
%
\declareconstitemvalue{PMIX_FABRIC_UPDATE_PENDING}{-176}
...
%
\declareconstitemvalue{PMIX_FABRIC_UPDATED}{-175}
...
%
\declareconstitemvalue{PMIX_FABRIC_UPDATE_ENDPOINTS}{-113}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Fabric endpoint support functions}
\label{api:netend:functions}

The following functions are provided to support the \refstruct{pmix_endpoint_t} structure.

%%%%
\littleheader{Initialize the endpoint structure}
\declareapiProvisional{PMIx_Endpoint_construct}

Initialize the \refstruct{pmix_endpoint_t} fields.

\copySignature{PMIx_Endpoint_construct}{6.0}{
void \\
PMIx_Endpoint_construct(pmix_endpoint_t *m);
}
...
\declareapiProvisional{PMIx_Endpoint_destruct}

Destruct the \refstruct{pmix_endpoint_t} fields.

\copySignature{PMIx_Endpoint_destruct}{6.0}{
void \\
PMIx_Endpoint_destruct(pmix_endpoint_t *m);
}
...
\declareapiProvisional{PMIx_Endpoint_create}

Allocate and initialize a \refstruct{pmix_endpoint_t} array.

\copySignature{PMIx_Endpoint_create}{6.0}{
pmix_endpoint_t* \\
PMIx_Endpoint_create(size_t n);
}
...
Returns pointer to the array of \refstruct{pmix_endpoint_t} structures (handle)

%%%%
\littleheader{Release an endpoint array}
\declareapiProvisional{PMIx_Endpoint_free}

Release an array of \refstruct{pmix_endpoint_t} structures.

\copySignature{PMIx_Endpoint_free}{6.0}{
void \\
PMIx_Endpoint_free(pmix_endpoint_t *m) \\
\hspace*{24\sigspace}size_t n);
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Fabric coordinate support functions}
\label{api:netcoord:functions}

The following functions are provided to support the \refstruct{pmix_coord_t} structure.

%%%%
\littleheader{Initialize the coord structure}
\declareapiProvisional{PMIx_Coord_construct}

Initialize the \refstruct{pmix_coord_t} fields.

\copySignature{PMIx_Coord_construct}{6.0}{
void \\
PMIx_Coord_construct(pmix_coord_t *m)
}
...
\declareapiProvisional{PMIx_Coord_destruct}

Destruct the \refstruct{pmix_coord_t} fields.

\copySignature{PMIx_Coord_destruct}{6.0}{
void \\
PMIx_Coord_destruct(pmix_coord_t *m)
}
...
\declareapiProvisional{PMIx_Coord_create}

Allocate and initialize a \refstruct{pmix_coord_t} array.

\copySignature{PMIx_Coord_create}{6.0}{
pmix_coord_t* \\
PMIx_Coord_create(size_t n);
}
...
\declareapiProvisional{PMIx_Coord_free}

Release an array of \refstruct{pmix_coord_t} structures.

\copySignature{PMIx_Coord_free}{6.0}{
void \\
PMIx_Coord_free(pmix_coord_t *m) \\
\hspace*{24\sigspace}size_t n);
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Fabric geometry support functions}
\label{api:netgeom:functions}

The following functions are provided to support the \refstruct{pmix_geometry_t} structure.

%%%%
\littleheader{Initialize the geometry structure}
\declareapiProvisional{PMIx_Geometry_construct}

Initialize the \refstruct{pmix_geometry_t} fields.

\copySignature{PMIx_Geometry_construct}{6.0}{
void \\
PMIx_Geometry_construct(pmix_geometry_t *m);
}
...
\declareapiProvisional{PMIx_Geometry_destruct}

Destruct the \refstruct{pmix_geometry_t} fields.

\copySignature{PMIx_Geometry_destruct}{6.0}{
void \\
PMIx_Geometry_destruct(pmix_geometry_t *m);
}
...
\declareapiProvisional{PMIx_Geometry_create}

Allocate and initialize a \refstruct{pmix_geometry_t} array.

\copySignature{PMIx_Geometry_create}{6.0}{
pmix_geometry_t* \\
PMIx_Geometry_create(size_t n);
}
...
Returns pointer to the array of \refstruct{pmix_geometry_t} structures (handle)

%%%%
\littleheader{Release a geometry array}
\declareapiProvisional{PMIx_Geometry_free}

Release an array of \refstruct{pmix_geometry_t} structures.

\copySignature{PMIx_Geometry_free}{6.0}{
void \\
PMIx_Geometry_free(pmix_geometry_t *m) \\
\hspace*{24\sigspace}size_t n);
}
...
\begin{constantdesc}
%
\declareconstitemvalue{PMIX_COORD_VIEW_UNDEF}{0x00}
The coordinate view has not been defined.
%
\declareconstitemvalue{PMIX_COORD_LOGICAL_VIEW}{0x01}
...
%
\declareconstitemvalue{PMIX_COORD_PHYSICAL_VIEW}{0x02}
...
\begin{constantdesc}
%
\declareconstitemvalue{PMIX_LINK_STATE_UNKNOWN}{0}
The port state is unknown or not applicable.
%
\declareconstitemvalue{PMIX_LINK_DOWN}{1}
The port is inactive.
%
\declareconstitemvalue{PMIX_LINK_UP}{2}
The port is active.
%
\end{constantdesc}
...
\begin{constantdesc}
%
\declareconstitemvalue{PMIX_FABRIC_REQUEST_INFO}{0}
...
%
\declareconstitemvalue{PMIX_FABRIC_UPDATE_INFO}{1}
...
\declareapiProvisional{PMIx_Fabric_construct}

Initialize the \refstruct{pmix_fabric_t} fields.

\copySignature{PMIx_Fabric_construct}{6.0}{
void \\
PMIx_Fabric_construct(pmix_fabric_t *m)
}
...
%
\declareAttribute{PMIX_FABRIC_COST_MATRIX}{"pmix.fab.cm"}{pointer}{
...
%
\declareAttribute{PMIX_FABRIC_GROUPS}{"pmix.fab.grps"}{string}{
...
%
\declareAttribute{PMIX_FABRIC_PLANE}{"pmix.fab.plane"}{string}{
...
%
\declareAttribute{PMIX_FABRIC_SWITCH}{"pmix.fab.switch"}{string}{
...
%
\declareAttribute{PMIX_FABRIC_VENDOR}{"pmix.fab.vndr"}{string}{
Name of the vendor (e.g., Amazon, Mellanox, HPE, Intel) for the specified fabric.
}
%
\declareAttribute{PMIX_FABRIC_IDENTIFIER}{"pmix.fab.id"}{string}{
...
%
\declareAttribute{PMIX_FABRIC_NUM_DEVICES}{"pmix.fab.nverts"}{size_t}{
Total number of fabric devices in the overall system - corresponds to the number of rows or columns in the cost matrix.
}
%
\declareAttribute{PMIX_FABRIC_DIMS}{"pmix.fab.dims"}{uint32_t}{
...
%
\declareAttribute{PMIX_FABRIC_SHAPE}{"pmix.fab.shape"}{pmix_data_array_t*}{
...
%
\declareAttribute{PMIX_FABRIC_SHAPE_STRING}{"pmix.fab.shapestr"}{string}{
...
%
\declareAttribute{PMIX_FABRIC_DEVICES}{"pmix.fab.devs"}{pmix_data_array_t}{
...
%
\declareAttribute{PMIX_FABRIC_COORDINATES}{"pmix.fab.coords"}{pmix_data_array_t}{
...
%
\declareAttribute{PMIX_FABRIC_DEVICE}{"pmix.fabdev"}{\refstruct{pmix_data_array_t}}{
...
%
\declareAttribute{PMIX_FABRIC_DEVICE_INDEX}{"pmix.fabdev.idx"}{uint32_t}{
Index of the device within an associated communication cost matrix.
}
%
\declareAttribute{PMIX_FABRIC_DEVICE_NAME}{"pmix.fabdev.nm"}{string}{
...
%
\declareAttribute{PMIX_FABRIC_DEVICE_VENDOR}{"pmix.fabdev.vndr"}{string}{
Indicates the name of the vendor that distributes the device.
}
%
\declareAttribute{PMIX_FABRIC_DEVICE_BUS_TYPE}{"pmix.fabdev.btyp"}{string}{
The type of bus to which the device is attached (e.g., "PCI", "GEN-Z").
}
%
\declareAttribute{PMIX_FABRIC_DEVICE_VENDORID}{"pmix.fabdev.vendid"}{string}{
This is a vendor-provided identifier for the device or product.
}
%
\declareAttribute{PMIX_FABRIC_DEVICE_DRIVER}{"pmix.fabdev.driver"}{string}{
The name of the driver associated with the device.
}
%
\declareAttribute{PMIX_FABRIC_DEVICE_FIRMWARE}{"pmix.fabdev.fmwr"}{string}{
The device’s firmware version.
}
%
\declareAttribute{PMIX_FABRIC_DEVICE_ADDRESS}{"pmix.fabdev.addr"}{string}{
...
%
\declareAttribute{PMIX_FABRIC_DEVICE_MTU}{"pmix.fabdev.mtu"}{size_t}{
The maximum transfer unit of link level frames or packets, in bytes.
}
%
\declareAttribute{PMIX_FABRIC_DEVICE_SPEED}{"pmix.fabdev.speed"}{size_t}{
The active link data rate, given in bits per second.
}
%
\declareAttribute{PMIX_FABRIC_DEVICE_STATE}{"pmix.fabdev.state"}{\refstruct{pmix_link_state_t}}{
...
%
\declareAttribute{PMIX_FABRIC_DEVICE_TYPE}{"pmix.fabdev.type"}{string}{
Specifies the type of fabric interface currently active on the device, such as Ethernet or InfiniBand.
}
%
\declareAttribute{PMIX_FABRIC_DEVICE_PCI_DEVID}{"pmix.fabdev.pcidevid"}{string}{
...
%
\declareAttribute{PMIX_SWITCH_PEERS}{"pmix.speers"}{pmix_data_array_t}{
