...
\argin{args}{Python dictionary containing:
    \begin{itemize}
        ...
        \item 'targets': List of Python \refpy{proc} identifying the namespace/rank of the processes to be aborted (list)
    \end{itemize}}
\end{arglist}
...
\argin{args}{Python dictionary containing:
    \begin{itemize}
        ...
        \item 'directives': List of Python \refpy{info} dictionaries containing data and directives (list)
    \end{itemize}}
\end{arglist}
