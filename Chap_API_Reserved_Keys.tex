...
For process-related keys (other than \refattr{PMIX_PROCID}) 
...
They will return information about the either the local node or the node specified by \refattr{PMIX_HOSTNAME} or \refattr{PMIX_NODEID}:
