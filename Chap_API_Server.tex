...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Server datatypes}
\label{chap:api_init:serverdt}
...
\begin{itemize}
    \item \pasteAttributeItem{PMIX_HWLOC_SHMEM_FILE}
    \item \pasteAttributeItem{PMIX_HWLOC_SHMEM_ADDR}
    \item \pasteAttributeItem{PMIX_HWLOC_SHMEM_SIZE}
    \item \pasteAttributeItem{PMIX_HWLOC_XML_V1}
    \item \pasteAttributeItem{PMIX_HWLOC_XML_V2}
\end{itemize}
